# Building Blocks – Data Manipulation
## Purpose
...
```mermaid
  flowchart TD
    A[🚀 Manual Trigger] --> B[📊 Data Sources]
    B --> C{Data Processing}
    C --> D[🔍 Deduplicate Records]
    C --> E[📋 Compare Lists]
    C --> F[📦 Group by Field]
    C --> G[📄 Flatten JSON]
    C --> H[✨ Extract Unique Values]
    D --> I[✅ Clean Data Output]
    E --> J[✅ Matched Records]
    E --> K[✅ Unmatched Records]
    F --> L[✅ Grouped Data]
    G --> M[✅ Flat Structure]
    H --> N[✅ Unique Values]
